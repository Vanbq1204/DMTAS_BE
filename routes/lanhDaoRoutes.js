...
const signatureAssetController = require('../controllers/signatureAssetController');
...
router.use(verifyToken, requireRole('lanh_dao'));
...
// Leader's incoming documents
router.get('/van-ban-den', incomingDocumentController.getLeaderIncomingDocuments);
router.get('/assignment-targets', incomingDocumentController.getAssignmentTargets);
router.post('/assign', incomingDocumentController.assignDocument);
router.post('/ket-thuc-theo-doi', incomingDocumentController.ketThucTheoDoi);
...
router.get('/du-thao/:id/files/:fileId/sign-preview-pdf', duThaoController.getSignPreviewPdf);
...
router.post('/du-thao/:id/files/:fileId/sign-image', duThaoController.signDuThaoPdfWithAsset);

/* ─── Cài đặt chữ ký/con dấu ─── */
router.get('/signature-assets', signatureAssetController.listAssets);
router.post('/signature-assets', memoryUpload.single('asset'), signatureAssetController.uploadAsset);
router.put('/signature-assets/:id', signatureAssetController.updateAsset);
router.delete('/signature-assets/:id', signatureAssetController.deleteAsset);
router.get('/signature-assets/:id/file', signatureAssetController.streamAsset);
